...
@EnableJpaAuditing(auditorAwareRef = "userTokenAware", dateTimeProviderRef = "dateTimeProvider")
...
public class PersistenceContextConfig {
    ...
    public HibernateJpaSessionFactoryBean sessionFactory(@Qualifier("entityManagerFactory") EntityManagerFactory emf) {
        HibernateJpaSessionFactoryBean jpaSessionFactory = new HibernateJpaSessionFactoryBean();
        jpaSessionFactory.setEntityManagerFactory(emf);
        return jpaSessionFactory;
    }

    @Bean(name = "userTokenAware")
    public UserTokenAware userTokenAware() {
